            ...
            <div class="mb-6">
                <form action="{{ route('admin.blogUpdate', ['id' => $post->id ]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="w-full rounded border border-gray-300 focus:outline-none py-2 px-2 text-gray-400 @error('title') border-red-500 @enderror" name="title" id="title" value="{{ old('title') ? old('title') : $post->title }}" />
                        @error('title')
                        <div class="mt-1">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="w-full rounded border border-gray-300 focus:outline-none py-2 px-2 text-gray-400 @error('body') border-red-500 @enderror" name="body" id="body">{{ old('body') ? old('body') : $post->body }}</textarea>
                        @error('body')
                        <div class="mt-1">
                            <p class="block text-red-500 text-sm">{{ $message }}</p>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="w-full rounded border border-gray-300 focus:outline-none py-2 px-2 text-gray-400 @error('tag') border-red-500 @enderror" name="tag" id="tag" value="{{ old('tag') ? old('tag') : $post->tag }}" />
                        @error('tag')
                        <div class="mt-1">
                            <p class="block text-red-500 text-sm">{{ $message }}</p>
                        </div>
                    ...
                    <div class="mt-5">
                        <button type="submit" class="py-3 px-5 flex items-center bg-blue-500 focus:outline-none text-white text-sm lg:text-base rounded font-medium tracking-wide hover:bg-blue-600 transition ease-out duration-150">
