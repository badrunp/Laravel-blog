                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200">
                            <td class="text-sm py-3 px-5 tracking-wide leading-5 text-gray-400 font-normal"><?= $i++; ?></td>
                            ...
                            <td class="flex items-center py-3 px-5 space-x-2">
                                ...
                                <a href="{{ route('admin.blogEdit', ['slug' => $post->slug ]) }}" class="py-2 px-3 bg-green-500 text-white text-xs rounded font-medium hover:bg-green-600 transition duration-150 ease-out">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                        <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                    </svg>
                                </a>
                                <button class="py-2 px-3 bg-yellow-500 text-white text-xs rounded font-medium hover:bg-yellow-600 transition duration-150 ease-out">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        @empty
                        <tr>
                            <td class="text-sm py-3 px-5 tracking-wide leading-5 text-gray-400 font-normal text-center" colspan="8">No Posts result</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
