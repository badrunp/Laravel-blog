    ...
    <div class="banner w-full max-h-screen bg-white relative">
        ...
        <div class="absolute top-2/4 lg:top-4/5 left-9 md:left-16 transform -translate-y-2/4">
            <div class="text-left w-3/5 -mt-8">
                ...
                <a href="" class="block py-2 md:py-3 px-4 md:px-5 lg:px-6 bg-red-500 w-max rounded text-gray-100 font-medium text-sm md:text-lg mt-4 md:mt-7 hover:bg-red-600 transition ease-out duration-150 uppercase">View blog</a>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white shadow-lg rounded">
                <div class="py-6 px-5 border-b border-gray-300">
                    <div class="flex items-center justify-between">
                        <span class="text-lg md:text-2xl font-medium text-gray-500"><i class="fas fa-poll text-red-600 mr-1"></i>Tranding Posts</span>
                        ...
                        <div class="shadow-sm border border-gray-200 rounded overflow-hidden hover:shadow-xl transition duration-150 ease-out">
                            ...
                            <div class="py-3 px-4">
                                ...
                                <div class="text-left mt-3">
                                    <a href="#" class="block text-base text-blue-500 font-medium hover:underline transition duration-150 ease-out">{{ Str::limit($post->title, 20) }}</a>
                                </div>
    ...
    <div class="my-10 md:my-16">
        <div class="mx-auto max-w-xs sm:max-w-sm md:max-w-none md:w-4/5 ">
            <div class="bg-white shadow-lg rounded">
                <div class="py-6 px-5 border-b border-gray-300">
                    <div class="flex items-center justify-between">
                        <span class="text-lg md:text-2xl font-medium text-gray-500"><i class="fas fa-newspaper text-red-600 mr-1"></i>Latest Posts</span>
                        <a href="#" class="flex items-center text-sm tracking-wide text-blue-500 hover:underline">
                            View All
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
    ...
    <div class="my-10 md:my-16">
        <div class="mx-auto max-w-xs sm:max-w-sm md:max-w-none md:w-4/5 ">
            <div class="bg-white shadow-lg rounded">
                <div class="py-6 px-5 border-b border-gray-300">
                    <div class="flex items-center justify-between">
                        <span class="text-lg md:text-2xl font-medium text-gray-500"><i class="fas fa-eye text-red-600 mr-1"></i>Top Views Posts</span>
                        <a href="#" class="flex items-center text-sm tracking-wide text-blue-500 hover:underline">
                            View All
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
